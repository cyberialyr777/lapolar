...
if (isset($_GET['txtID'])) {
  ...
  $sentencia = $conexion->prepare("SELECT * FROM proveedores WHERE id_proveedor=:id");
...
if($_POST){
  ...
  $sentencia = $conexion->prepare("UPDATE proveedores SET 
        ...
        <div class="container formulario">
          <form method="post" class="form" action="" enctype="multipart/form-data">
            <div class="mb-3">
              ...
              <input value="<?php echo $txtID; ?>" type="text" class="form-control id" name="txtID" id="txtID" placeholder="ID">
            </div>
            <div class="mb-3">
            ...
            <select class="form-select esta" name="id_estado" aria-label="Seleccionar colonia">
