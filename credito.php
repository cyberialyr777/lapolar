...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $proveedores = isset($_POST['id_proveedor']) ? (int)$_POST['id_proveedor'] : 0;
    ...
    $sentencia = $conexion->prepare("INSERT INTO `deudas` (`NUMERO_DE_FACTURA`, `ID_PROVEEDOR`, `MONTO`, `FECHA_LIMITE`, `FECHA_CREACION`, `FECHA_ACTUALIZACION`) VALUES (:numero_de_factura, :id_proveedor, :monto, :fecha_limite, NOW(), NOW())");
...
$sentencia = $conexion->prepare("SELECT * FROM `deudas`");
$sentencia->execute();
...
if (isset($_GET['eliminar'])) {
    $txtID = $_GET['eliminar'];
    $sentencia = $conexion->prepare("DELETE FROM deudas WHERE NUMERO_DE_FACTURA = :numero_de_factura");
...
<body>
            ...
            <div class="col-sm-9" style="margin-bottom: 280px;">
                <div class="row">
                    ...
                    <div class="buscador col-sm-4">
                        <form class="d-flex">
                            <input id="searchInput" class="form-control me-2" type="text" placeholder="Encontrar créditos" />
                            ...
                            <form action="" enctype="multipart/form-data" method="post">
                                <div class="form">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control numero_de_factura" name="numero_de_factura" id="formGroupExampleInput2" placeholder="56">
                                    </div>
                                    <div class="mb-3">
                                        <label for="formGroupExampleInput2" class="form-label">En crédito</label>
                                        <input name="monto" type="text" class="form-control" id="formGroupExampleInput2" placeholder="2344">
                                    </div>
                                    <div class="mb-3">
                    ...
                    <?php foreach ($lista_creditos as $registros) { ?>
                        <div class="cobross">
                            <div class="row">
                                ...
                                <a name="" id="" class="eliminar btn col-sm-1 btn-sm" href="<?php echo $_SERVER['PHP_SELF'] . '?eliminar=' . $registros['NUMERO_DE_FACTURA']; ?>" role="button" style="margin-top: 6%; margin-right: 4%;">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script src="./js/busqueda_creditos.js"></script>
