...
if (isset($_GET['txtID'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM cobros WHERE numero_de_factura=:numero_de_factura");
...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("UPDATE cobros SET 
                    ...
                    <form action="" enctype="multipart/form-data" method="post" class="form">
                        <div class="form">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="<?php echo $servicio; ?>" name="servicio" type="text" class="form-control" id="formGroupExampleInput" placeholder="Cambio de bandas">
                            </div>
                            <select class="form-select" name="id_cliente" aria-label="Seleccionar cliente/empresa" style="margin-bottom: 1%;">
                                <option value="" disabled>Seleccionar cliente/empresa</option>
                                <?php foreach ($clientes as $clienteItem) { ?>
                                    <option value="<?php echo $clienteItem['ID_CLIENTE']; ?>" <?php if ($cliente == $clienteItem['ID_CLIENTE']) echo "selected"; ?>><?php echo $clienteItem['NOMBRE']; ?></option>
                                <?php } ?>
                            </select>
