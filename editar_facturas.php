...
if (isset($_GET['txtID'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM facturas_clientes WHERE numero_de_factura=:numero_de_factura");
...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("UPDATE facturas_clientes SET 
                ...
                <div class="container formulario">
                    <form action="" enctype="multipart/form-data" method="post" class="form">
                        <div class="form">
                            ...
                            <select class="form-select" name="id_cliente" aria-label="Seleccionar cliente/empresa">
