...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sentencia = $conexion->prepare("INSERT INTO `clientes` (`ID_CLIENTE`, `ID_MUNICIPIO`, `ID_ESTADO`, `ID_COLONIA`, `NOMBRE`, `TELEFONO`, `CORREO`, `REPRESENTANTE_NOMBRE`, `REPRESENTANTE_APELLIDO_PATERNO`, `CALLE`, `NUMERO`, `C_P_`, `FECHA_CREACION`, `FECHA_ACTUALIZACION`) VALUES (NULL, :id_municipio, :id_estado, :id_colonia, :nombre, :telefono, :correo, :representante_nombre, :representante_apellido_paterno , :calle, :numero, :c_p_, NOW(), NOW())");
...
<body>
            ...
            <form action="" enctype="multipart/form-data" method="post">
              <div class="form">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control nombre" name="nombre" id="nombre" placeholder="Chedraui">
                </div>
                <div class="mb-3">
        ...
        <div class="fondo container-fluid row">
          ...
          <div class="buscador col-sm-4">
            <form method="get" class="d-flex">
              <input id="search-client" class="form-control me-2" type="text" placeholder="Encontrar clientes" onkeyup="buscar_cliente()" />
            ...
            <tbody>
              <?php foreach ($lista_clientes as $registros) { ?>
                <tr>
                  ...
                  <td>
                    <a name="editar" id="" class="editar btn btn-light" href="editar_clientes.php?txtID=<?php echo $registros['ID_CLIENTE']; ?>" role="button">
                    ...
                    <a name="" id="" class="eliminar btn btn-light" href="<?php echo $_SERVER['PHP_SELF'] . '?eliminar=' . $registros['ID_CLIENTE']; ?>" role="button">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <script src="./js/busqueda_clientes.js"></script>
